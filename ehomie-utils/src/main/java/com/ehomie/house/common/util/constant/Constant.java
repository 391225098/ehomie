package com.ehomie.house.common.util.constant;
...
public class Constant {
    ...
    public final static String COOKIE_USER = "ec3_user";
    public final static String WEBSOCKET_KEFU = "websocket_kefu";                       //websocket多客服
    public final static String COOKIE_USER_TOKEN = "user_token";                        //登录用户TOKEN

    public final static String COOKIE_KEFU_USER = "cookie_kefu_user";                   //客服cookie
    public final static String COOKIE_KEFU_TOKEN = "cookie_kefu_token";                 //客服cookie
    ...
    public final static String REDIS_KEFU_USER_PREFIX = "kefu_user_";
    public final static String REDIS_KEFU_USER_MAP = "kefu_user_map";

    public final static String REDIS_KEFU_SEND_NEWS_PREFIX = "kefu_sendnews_";
