package com.ehomie.house.common.util.string;



import com.ehomie.house.common.pattern.PatternUtil;
...
public class StringUtil {
    ...
    public final static String REGEX_MOBILE = "^(13[0-9]||15[0123456789]||18[0123456789]||147||145||17[0123456789])\\d{8}$";
...
//    }
    ...
    public static List<String> stringConvertToListByComma(String str) {
        String[] s = str.split(",");
        List<String> list = new ArrayList<>();
        for (int i = 0; i < s.length; i++) {
            list.add(s[i]);
    ...
    //region 将数组转为"123","234"格式的字符串
    public static String stringArrConvertString(String[] strings) {
    ...
    public static void main(String[] args) {
        String s = "PRCID#分区#省#城市#店面名称#店面地址#店面级别#业代账号#业代姓名#督导账号#督导姓名#检测日期#检测时间#problem检测人员";
        List<String> list = stringConvertToList(s);
        System.out.print(list);

        Date date = new Date(1461600000000l);
